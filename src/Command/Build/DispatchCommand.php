...
class DispatchCommand extends AbstractCommand
{
    ...
    public function __construct(
        ...
        parent::__construct(
            'build:dispatch',
            'Loop through QUEUED builds, merge same project builds and update build status to DISPATCHED ' .
            'for the oldest build that have been created more than 1 minute ago',
            [
